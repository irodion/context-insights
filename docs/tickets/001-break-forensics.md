...
over 241 mid-Turn breaks. The reasoning above stands for the 71 that remain — what
...
Floor, and Retention is now measured above it. Req 16 still reads *turn-boundary history rewrite*, at
the same 16%: that Session gets no Prefix Floor, because its smallest cache rebuild
(5,504 at req 17) sits *below* the 9,600 head and nothing corroborates it, and 013
declines to look past an uncorroborated minimum. A 109s gap
